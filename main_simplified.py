...
def translate_statement(statement):
    """
    Translates a natural language statement into logical expressions for both domains,
...
def main():
    ...
    if args.statement:
        ...
        result = translate_statement(args.statement)
        print("\nResult:")
        domain = detect_domain(args.statement)
        print(f"Domain: {'Students in this class' if domain == 'students' else 'All People'}")
        print(f"Logical Expression: {result}")
    else:
